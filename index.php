          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-md-4 col-sm-5">
                         <p>Kami Pastikan Kendaraan Anda Akan Bersih Seperti Baru</p>
                    </div>

                    <div class="col-md-8 col-sm-7 text-align-right">
                         <span class="phone-icon"><i class="fa fa-phone"></i> 010-060-0160</span>
                         <span class="date-icon"><i class="fa fa-calendar-plus-o"></i> 09.00 - 17:00 (Setiap Hari)</span>
                    </div>
     ...
     <section class="navbar navbar-default navbar-static-top" role="navigation">
          <div class="container">
               ...
               <div class="navbar-header">
                    ...
                    <!-- lOGO TEXT HERE -->
                    <!-- <a href="index.html" class="navbar-brand"><i class="fa fa-h-square"></i>CuMil</a> -->
               </div>
               ...
               <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                         ...
                         <li class="btn-primary"><a href="login.php">Login</a></li>
                    </ul>
               </div>
...
?>
                                   ...
                                   <button class="btn btn-primary btn-block">Daftar Sekarang</button>
                                        <!-- <button type="submit" class="form-control" id="primary-submit" name="submit">Daftar Sekarang</button> -->
                                   </div>
                              </div>
                        </form>
                    </div>
                    ...
                    <div class="col-md-12 col-sm-12">
                         ...
                         <form id="saran-form" role="form" method="post" action="pages/proses_saran.php">
                              ...
                              <div class="wow fadeInUp" data-wow-delay="0.8s">
                                   ...
                                   <div class="col-md-12 col-sm-12">
                                   <button class="btn btn-primary btn-block">Kirim Sekarang</button>
                    ...
                    <div class="col-md-4 col-sm-4">
                         <div class="footer-thumb">
                              <div class="opening-hours">
                                   ...
                                   <p>Senin - Minggu <span>09:00 - 17:00</span></p>
                              </div>
                         </div>
                    </div>
